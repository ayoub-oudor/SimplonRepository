        ...
        <div class="col-md-10 mx-auto">
            <div class="card">
                <div class="card-body bg-light">
				    ...
				    <div class="clearfix">
				      <button type="button" class="insertbtn"><a href="profAdd.jsp">Add Professeur</a></button>
				      <button type="button" class="insertbtn"><a href="profUpdate.jsp">Update Professeur</a></button>
							  ...
							  <tr>
							  	...
							  	<td>
							  	        <form method="post" class="mr-1" action="update">
                                            <input type="hidden" name="id" value="  <c:out value="${professeur.professeur_id}"/>">
